...
@Stateful
@SessionScoped
public class InsuredPopulate {

    private List<InsuredPopulate.Column> rows;
    ...
    public InsuredPopulate() {
        this.rows = new ArrayList<InsuredPopulate.Column>();
    ...
    public List<InsuredPopulate.Column> getRows() {
        return rows;
    }

    public void setRows(List<InsuredPopulate.Column> rows) {
        this.rows = rows;
    }
